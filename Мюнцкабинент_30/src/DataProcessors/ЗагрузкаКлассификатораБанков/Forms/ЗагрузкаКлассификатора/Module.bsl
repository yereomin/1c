...
Процедура ЗагрузитьКлассификатор()
	...
	Если ВариантЗагрузки = "ИТС" Тогда
		...
		Возврат;
	ИначеЕсли ВариантЗагрузки = "Интернет" Тогда
		ДлительнаяОперация = ПолучитьДанныеНаСервере(ПараметрыЗагрузкиКлассификатора);
...
Процедура ПолучитьДанныеБИКРФДискИТС(ПараметрыЗагрузкиКлассификатора) 
	...
	// Другие параметры - см. описание переменной ПараметрыЗагрузкиФайлов в ЗагрузитьКлассификатор():
...
// Параметры:
	...
	Обработки.ЗагрузкаКлассификатораБанков.ЗагрузитьДанныеДискИТС(ПараметрыЗагрузкиФайловИТС);
