...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НастройкиФайлов.НеСоздаватьФайлыПоШаблону.Найти(Метаданные.НайтиПоТипу(ТипЗнч(ВладелецФайла))) <> Неопределено Тогда
...
Процедура СоздатьГруппу(Команда)
	...
	ТекущиеДанные = Элементы.Список.ТекущиеДанные;
	Если ТекущиеДанные.ВладелецФайла <> ВладелецФайла Тогда
	...
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Родитель",       ТекущиеДанные);
...
Функция ПолучитьИменаКомандИзмененияОбъектов()
	...
	ИменаКоманд.Добавить("Добавить");
	ИменаКоманд.Добавить("СоздатьГруппу");
