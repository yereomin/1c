...
// Устарела. Следует использовать ОбщегоНазначения.СоздатьВременныйКаталог.
// Создает каталог временных файлов.
//
// Параметры:
...
Функция СоздатьКаталогВременныхФайлов(Расширение) Экспорт
	Возврат ОбщегоНазначения.СоздатьВременныйКаталог(Расширение);
КонецФункции

// Устарела. Следует использовать ОбщегоНазначения.УдалитьВременныйКаталог.
// Очищает каталог временных файлов вместе с его содержимым.
//
// Параметры:
