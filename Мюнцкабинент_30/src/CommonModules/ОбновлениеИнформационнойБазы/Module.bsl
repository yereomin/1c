...
//                                                      В ключах соответствия лежат пути к реквизитам шапки документа
//                                                      или реквизитам табличных частей,
...
//
Функция ЭтоВызовИзОбработчикаОбновления() Экспорт
	Возврат ЗначениеЗаполнено(ПараметрыСеанса.ПараметрыОбработчикаОбновления.РежимВыполнения);
КонецФункции
